# -*- coding: utf-8 -*-
"""
Created on Sat Oct 17 13:03:04 2020
...
muhtasim_image = face_recognition.load_image_file("samples/mash.jpg")
muhtasimenco = face_recognition.face_encodings(muhtasim_image)[0]
#%%

known_face_encodings = [modi_face_encodings, trump_face_encodings, muhtasimenco]
known_face_names = ["Narendra Modi", "Donald Trump", "muhtasim"]
