# -*- coding: utf-8 -*-
"""
Created on Fri Oct 16 22:47:29 2020
...
while True:
    ...
    for index,current_face_location in enumerate(all_face_locations):
        ...
        #creating the model
        gender_cov_net = cv2.dnn.readNetFromDarknet(gender_caffemodel, gender_protext)
        ...
        age_caffemodel = "dataset/age_net.caffemodel"
        #creating the model
        age_cov_net = cv2.dnn.readNetFromDarknet(age_caffemodel, age_protext)
        #giving input to the model
